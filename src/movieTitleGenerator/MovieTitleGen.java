...
public class MovieTitleGen
{
    public static void main(String[] args) throws Exception
    {
        ...
        int selectAdjectives = random.nextInt(adjectives.length); 
        int selectNouns = random.nextInt(nouns.length);
        //System.out.println(adjectives[select]);
       /* String adjective = "Cool";
        String noun = "Dave";*/

        System.out.println( "Your movie title is: " + adjectives[selectAdjectives] + " " + nouns[selectNouns] );
    }
